...
## 前言
 ...
 - 如果你在安装使用过程中遇到问题，请在issues中详细提交你的问题日志，我会在闲暇时间处理该问题
 - 如果你也想对这个项目有任何好的建议，也欢迎提交相应的issues，我会仔细考虑，有益的话会进行相应更新
 - 开源项目需要每个人的支持，希望各位可以给这个项目提交一些漏洞模板，让这块更加丰富
 - 这个项目其实有很多使用场景，比如白帽子挖洞，甲方做内外网资产安全自监测，再比如平时对h1和bc资产做实时监测，后期有一个子域名库，挖掘出某产品0day后，对这些以万为单位的子域名进行扫描
 - 最后希望白帽子群体收获多多，各企业在这个时代也能更加安全，如果你通过这个工具挖到一些巨额bounty的漏洞，也可以在项目issues处截个图，后期整理个bounty合集
